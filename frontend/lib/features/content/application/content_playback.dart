...
/// Shared "play" action for a piece of content: fetches a fresh presigned
/// stream URL and either starts the persistent audio player or pushes the
/// full-screen video player. Shared between [ContentDetailScreen]'s hero
/// play button and the home shelf's content-card play button so the two
/// entry points can't drift out of sync. Callers own their own
/// loading-state flag around the `await` — this only handles the
/// fetch/dispatch/error-toast, not UI.
